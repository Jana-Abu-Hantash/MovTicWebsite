            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <form class="d-flex gap-4 py-2">
                        <a class="btn px-5" style="background-color: rgb(130, 48, 56); color: white; font-size: 1rem; font-family: Times;" onclick="handleClick(this)" href="http://localhost/MovTic/HomePage.html"> Log Out</a>                        
                    </form>
                    ...
                    <div class="Movie_info col-md-7 py-5">
                        <div class="row">
                            ...
                            <div class="py-4">
                                ...
                                <a class="Main_btn btn btn-lg"
                                    href="http://localhost/MovTic/UserLoggedIn/BookTickets.php"> <i
