...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-black">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" style="font-size: 1.6rem; font-family: Times;"  href="http://localhost/MovTic/HomePage.html"> <i class="bi bi-film"></i> MovTic</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-1 mb-md-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" style="font-size: 1.2rem; font-family: Times;" aria-current="page" href="http://localhost/MovTic/movies_info.php"> All Movies </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" style="font-size: 1.2rem; font-family: Times;" href="http://localhost/MovTic/UserLoggedin/Login.php"> Book a Ticket </a>
                </li>

            </ul>

            <form class="d-flex gap-4 py-2">
                <a class="btn btn-success px-5" style="font-size: 1rem; font-family: Times;" href="http://localhost/MovTic/UserLoggedin/login.php"> Log In</a>
                <a class="btn px-5" style="background-color: rgb(130, 48, 56); color: white; font-size: 1rem; font-family: Times;" href="http://localhost/MovTic/UserLoggedin/Signup.php"> Sign Up</a>
            </form>
    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            ...
            <!-- 1. Black Adam -->
            <div class="carousel-item" id="movie1">
                    ...
                    <div class="Movie_info col-md-7 py-5">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <h5>
                                    <?php foreach ($Actors_1 as $actor) {out($actor); }?> </h5>
                                    <h3 class="Main_text"> Duration: </h3>
                                    <h5> <?php out($duration_1) ?>
                                </h5>
                                </p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <h5>
                                    <?php foreach ($genres_1 as $genre) {out("$genre ");} ?> </h5>
                                    <h3 class="Main_text"> Release Date: </h3>
                                    <h5> <?php out($releaseDate_1) ?>
                                </h5>
                                </p>
                            </div>
                            ...
                            <div class="py-4">
                                ...
                                <a class="Main_btn btn btn-lg" href="http://localhost/MovTic/UserLoggedin/Login.php"> <i class="bi bi-ticket-perforated"></i> Get
                                    Tickets </a>
                            </div>
                    ...
                    <div class="Movie_info col-md-7 py-5">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <h3 class="Main_text"> Cast Members: </h3>
                                <h5>
                                    <?php foreach ($Actors_2 as $actor) {out($actor); }?> </h5>
                                    <h3 class="Main_text"> Duration: </h3>
                                    <h5> <?php out($duration_2) ?>
                                </h5>
                                </p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <h3 class="Main_text"> Genres: </h3>
                                <h5>
                                    <?php foreach ($genres_2 as $genre) {out("$genre ");} ?> </h5>
                                    <h3 class="Main_text"> Release Date: </h3>
                                    <h5> <?php out($releaseDate_2) ?>
                                </h5>
                                </p>
                            </div>
                    ...
                    <div class="Movie_info col-md-7 py-5">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <h3 class="Main_text"> Cast Members: </h3>
                                <h5>
                                    <?php foreach ($Actors_3 as $actor) {out($actor); }?> </h5>
                                    <h3 class="Main_text"> Duration: </h3>
                                    <h5> <?php out($duration_3) ?>
                                </h5>
                                </p>
                            </div>
                            ...
                            <div class="col-md-6">
                                <p>
                                <h3 class="Main_text"> Genres: </h3>
                                <h5> <?php foreach ($genres_3 as $genre) {out("$genre");} ?> </h5>
                                    <h3 class="Main_text"> Release Date: </h3>
                                    <h5> <?php out($releaseDate_3) ?>
                                </h5>
                                </p>
                            </div>
                    ...
                    <div class="Movie_info col-md-7 py-5">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <h3 class="Main_text"> Cast Members: </h3>
                                <h5>
                                    <?php foreach ($Actors_4 as $actor) {out($actor); }?> </h5>
                                    <h3 class="Main_text"> Duration: </h3>
                                    <h5> <?php out($duration_4) ?>
                                </h5>
                                </p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <h3 class="Main_text"> Genres: </h3>
                                <h5>
                                    <?php foreach ($genres_4 as $genre) {out("$genre ");} ?> </h5>
                                    <h3 class="Main_text"> Release Date: </h3>
                                    <h5> <?php out($releaseDate_4) ?>
                                </h5>
                                </p>
                            </div>
                    ...
                    <div class="Movie_info col-md-7 py-5">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <h3 class="Main_text"> Cast Members: </h3>
                                <h5>
                                    <?php foreach ($Actors_5 as $actor) {out($actor); }?> </h5>
                                    <h3 class="Main_text"> Duration: </h3>
                                    <h5> <?php out($duration_5) ?>
                                </h5>
                                </p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <h3 class="Main_text"> Genres: </h3>
                                <h5>
                                    <?php foreach ($genres_5 as $genre) {out("$genre ");} ?> </h5>
                                    </br>
                                    <h3 class="Main_text"> Release Date: </h3>
                                    <h5> <?php out($releaseDate_5) ?>
                                </h5>
                                </p>
                            </div>
                    ...
                    <div class="Movie_info col-md-7 py-5">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <h3 class="Main_text"> Cast Members: </h3>
                                <h5>
                                    <?php foreach ($Actors_6 as $actor) {out($actor); }?> </h5>
                                    <h3 class="Main_text"> Duration: </h3>
                                    <h5> <?php out($duration_6) ?>
                                </h5>
                                </p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <h3 class="Main_text"> Genres: </h3>
                                <h5>
                                    <?php foreach ($genres_6 as $genre) {out("$genre ");} ?> </h5>
                                    <h3 class="Main_text"> Release Date: </h3>
                                    <h5> <?php out($releaseDate_6) ?>
                                </h5>
                                </p>
                            </div>
                    ...
                    <div class="Movie_info col-md-7 py-5">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <h3 class="Main_text"> Cast Members: </h3>
                                <h5>
                                    <?php foreach ($Actors_7 as $actor) {out($actor); }?> </h5>
                                    <h3 class="Main_text"> Duration: </h3>
                                    <h5> <?php out($duration_7) ?>
                                </h5>
                                </p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <h3 class="Main_text"> Genres: </h3>
                                <h5>
                                    <?php foreach ($genres_7 as $genre) {out("$genre ");} ?> </h5>
                                    <h3 class="Main_text"> Release Date: </h3>
                                    <h5> <?php out($releaseDate_7) ?>
                                </h5>
                                </p>
                            </div>
                        ...
                        <div class="Movie_info col-md-7 py-5">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <h3 class="Main_text"> Cast Members: </h3>
                                    <h5>
                                        <?php foreach ($Actors_8 as $actor) {out($actor); }?> </h5>
                                        <h3 class="Main_text"> Duration: </h3>
                                        <h5> <?php out($duration_8) ?>
                                    </h5>
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <h3 class="Main_text"> Genres: </h3>
                                    <h5>
                                        <?php foreach ($genres_8 as $genre) {out("$genre ");} ?> </h5>
                                        </br>
                                        <h3 class="Main_text"> Release Date: </h3>
                                        <h5> <?php out($releaseDate_8) ?>
                                    </h5>
                                    </p>
                                </div>
                        ...
                        <div class="Movie_info col-md-7 py-5">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <h3 class="Main_text"> Cast Members: </h3>
                                    <h5>
                                        <?php foreach ($Actors_9 as $actor) {out($actor); }?> </h5>
                                        <h3 class="Main_text"> Duration: </h3>
                                        <h5> <?php out($duration_9) ?>
                                    </h5>
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <h3 class="Main_text"> Genres: </h3>
                                    <h5>
                                        <?php foreach ($genres_9 as $genre) {out("$genre ");} ?> </h5>
                                        <h3 class="Main_text"> Release Date: </h3>
                                        <h5> <?php out($releaseDate_9) ?>
                                    </h5>
                                    </p>
                                </div>
    ...
    <div class="container">
        <footer class="py- my-4">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                <li class="nav-item"><a href="http://localhost/MovTic/HomePage.html" class="nav-link px-2 text-muted">Home</a></li>
                <li class="nav-item"><a href="http://localhost/MovTic/movies_info.php" class="nav-link px-2 text-muted">Movies</a></li>
            </ul>
